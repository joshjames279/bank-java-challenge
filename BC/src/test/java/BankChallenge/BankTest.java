...
public class BankTest {
    ...
    public void when1000Deposited500Withdrawn (){
        Object[][] transactions = new Object[][]{{"deposit","10/01/2012",1000.00},{"withdrawal", "14/01/2012",50.00}};
        Bank account = new Bank(transactions);
    ...
    public void acceptanceCriteria(){
        Object[][] transactions = new Object[][]{{"deposit","10/01/2012",1000.00},{"deposit", "13/01/2012",2000.00},{"withdrawal", "14/01/2012",500.00}};
        Bank account = new Bank(transactions);
    ...
    public void when2000Deposited1000Withdrawn100Deposited10_12WithdrawnWithStartingBalanceOf100 (){
        Object[][] transactions = new Object[][]{{"deposit","10/01/2012",2000.00},{"withdrawal", "11/01/2012",1000.00},{"deposit", "12/01/2012",100.00},{"withdrawal", "13/01/2012",10.12}};
        Bank account = new Bank(transactions,100.00);
